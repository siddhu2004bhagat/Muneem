...
export function WhatsAppShare() {
  ...
  const generateInvoicePDF = async (invoiceData: InvoiceData): Promise<Blob> => {
    ...
    doc.text(companySettings?.businessName || 'MUNEEM', pageWidth / 2, yPos, { align: 'center' });
    yPos += 8;
    ...
    doc.text('Generated by MUNEEM Accounting Solutions', pageWidth / 2, doc.internal.pageSize.getHeight() - 10, { align: 'center' });
